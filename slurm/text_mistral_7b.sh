#!/bin/bash
#SBATCH --job-name=text_mistral_7b
#SBATCH --partition=public
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=40G
#SBATCH --time=04:00:00
#SBATCH --output=logs/text_mistral_7b_%j.log
...
MODEL_PATH=/scratch/akalemul/hf_cache/hub/models--mistralai--Mistral-7B-Instruct-v0.3/snapshots/c170c708c41dac9275d15a8fff4eca08d52bab71//
PORT=8111
...
$VLLM serve $MODEL_PATH \
    ...
    --limit-mm-per-prompt '{"image":1}' > logs/vllm_mistral_${SLURM_JOB_ID}.log 2>&1 &
VLLM_PID=$!
...
for i in $(seq 1 90); do
    ...
    if ! kill -0 $VLLM_PID 2>/dev/null; then echo "vLLM died — see logs/vllm_mistral_${SLURM_JOB_ID}.log"; tail -40 logs/vllm_mistral_${SLURM_JOB_ID}.log; exit 1; fi
done
