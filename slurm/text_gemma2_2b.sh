#!/bin/bash
#SBATCH --job-name=text_gemma2_2b
#SBATCH --partition=public
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=40G
#SBATCH --time=04:00:00
#SBATCH --output=logs/text_gemma2_2b_%j.log
...
# (gemma-2 soft-cap: let vLLM choose backend)
...
MODEL_PATH=/scratch/akalemul/hf_cache/hub/models--google--gemma-2-2b-it/snapshots/299a8560bedf22ed1c72a8a11e7dce4a7f9f51f8//
PORT=8112
...
$VLLM serve $MODEL_PATH \
    ...
    --limit-mm-per-prompt '{"image":1}' > logs/vllm_gemma2_${SLURM_JOB_ID}.log 2>&1 &
VLLM_PID=$!
...
for i in $(seq 1 90); do
    ...
    if ! kill -0 $VLLM_PID 2>/dev/null; then echo "vLLM died — see logs/vllm_gemma2_${SLURM_JOB_ID}.log"; tail -40 logs/vllm_gemma2_${SLURM_JOB_ID}.log; exit 1; fi
done
