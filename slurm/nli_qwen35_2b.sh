#!/bin/bash
#SBATCH --job-name=nli_qwen35_2b
#SBATCH --partition=public
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=40G
#SBATCH --time=04:00:00
#SBATCH --output=logs/nli_qwen35_2b_%j.log
...
MODEL_PATH=/home/akalemul/.cache/huggingface/hub/models--Qwen--Qwen3.5-2B/snapshots/15852e8c16360a2fea060d615a32b45270f8a8fc
PORT=8120
...
$VLLM serve $MODEL_PATH \
    ...
    --dtype bfloat16 \
    --enforce-eager \
    --gpu-memory-utilization 0.45 --max-num-seqs 8 > logs/vllm_nli_2b_${SLURM_JOB_ID}.log 2>&1 &
VLLM_PID=$!
...
for i in $(seq 1 90); do
    ...
    if ! kill -0 $VLLM_PID 2>/dev/null; then echo "vLLM died — see logs/vllm_nli_2b_${SLURM_JOB_ID}.log"; tail -40 logs/vllm_nli_2b_${SLURM_JOB_ID}.log; exit 1; fi
done
